...
function Controls(props) {
  ...
  return (
    <div className="controls-wrapper nes-container is-rounded">
      ...
      <div>
        <button type="button" onClick={props.takeit} className="nes-btn">Pick Up</button>
        <button type="button" onClick={props.dropit} className="nes-btn">Drop</button> 
        <button type="button" onClick={props.sellit} className="nes-btn">Sell</button> 
